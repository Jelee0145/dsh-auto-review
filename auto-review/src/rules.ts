 ...
 */
export function compilePatterns(field: string, patterns: readonly string[]): RegExp[] {
 ...
 */
export function commandTextOf(callArguments: Readonly<Record<string, JsonValue>>): string {
