 ...
 */
export declare function fingerprintOf(toolName: string, operationText: string): string;
/** Per-session consecutive-denial counts keyed by operation fingerprint. */
export declare class DenialFuse {
    private counts;
    /**
...
export declare const denialFuse: DenialFuse;
